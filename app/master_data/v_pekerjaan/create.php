...
if (!empty($_POST)) {
    ...
    if ($valid) {
        ...
        $sql = "INSERT INTO tb_pekerjaan(nama_pekerjaan) values(?)";
        $q = $pdo->prepare($sql);
        $q->execute(array($nama_pekerjaan));
        Database::disconnect();
    ...
    <div class="right-side strech">
        ...
        <form class="form-horizontal" action="create.php" method="post">
            <div class="control-group <?php echo!empty($nama_pekerjaanError) ? 'error' : ''; ?>">
                ...
                <div class="controls">
                    <input name="nama_pekerjaan" type="text"  placeholder="Name" value="<?php echo!empty($nama_pekerjaan) ? $nama_pekerjaan : ''; ?>">
